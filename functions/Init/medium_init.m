...
classdef medium_init
   ...
   properties
   r_hcf,area_hcf,fullarea_hcf,Fluence,temperature,pressure,n2,n0,n,Iconst,gas,r_mode,k,k0,n0pressure,npressure,n_ext,npressure_ext,kGV,kGVD,kTOD,k1_w0,k2_w0
   end
methods
...
%         s.n2=2*7.5e-25;%@1barr pressure #### [m^2/W] Nonlinear refractive index
    ...
    s.n_ext=[zeros(1,mesh.fmid),s.n];
    s.npressure_ext=[zeros(1,mesh.fmid),s.npressure];
